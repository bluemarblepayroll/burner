...
* **b/collection/dynamic_arrays_to_objects** [keys_register, register, separator]: Map an array of arrays to an array of hashes.  These keys can be realized at run-time as they are pulled from another register (`keys_register`) thus making it dynamic.
